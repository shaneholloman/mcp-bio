...
mod tests {
    ...
    use super::{
        ChartArgs, ChartType, Cli, Commands, DrugCommand, GeneCommand, McpChartPass, OutputStream,
        PaginationMeta, ProteinCommand, StudyCommand, VariantCommand, VariantSearchPlan,
