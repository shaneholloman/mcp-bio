...
pub use self::adverse_event::{
    adverse_event_count_markdown, adverse_event_guidance_commands, adverse_event_markdown,
    adverse_event_search_markdown, adverse_event_search_markdown_with_context,
