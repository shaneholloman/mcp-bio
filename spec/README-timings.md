...
| `spec/07-disease.md` | `Canonical CLL Disease Genes` | `2.45s` | passed | `1.88s` | passed | fast | keep in spec-pr | Fast and stable on both passes, so the heading stays in the PR-blocking lane. |
...
| `spec/07-disease.md` | `Canonical CMT1A Disease Genes` | `2.26s` | passed | `1.17s` | passed | fast | keep in spec-pr | Fast and stable on both passes, so the heading stays in the PR-blocking lane. |
| `spec/07-disease.md` | `Canonical Parkinson Disease Genes` | `2.26s` | passed | `1.28s` | passed | fast | keep in spec-pr | Fast and stable on both passes, so the heading stays in the PR-blocking lane. |
...
| `spec/07-disease.md` | `Canonical T-PLL Disease Genes` | `2.20s` | passed | `2.10s` | passed | fast | keep in spec-pr | Fast and stable on both passes, so the heading stays in the PR-blocking lane. |
